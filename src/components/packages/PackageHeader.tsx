    ...
    <div className="bg-white/90 backdrop-blur-sm rounded-xl sm:rounded-2xl p-4 sm:p-6 lg:p-8 shadow-xl border border-gray-100">
      <div className="flex flex-col lg:flex-row lg:items-center justify-between mb-4 sm:mb-6">
        <div className="space-y-3 sm:space-y-4">
          <h1 className="text-2xl sm:text-3xl lg:text-4xl font-bold text-gray-900 bg-gradient-to-r from-orange-600 to-red-600 bg-clip-text leading-tight">
            {title}
          </h1>
          <div className="flex flex-col sm:flex-row sm:flex-wrap items-start sm:items-center gap-2 sm:gap-3 lg:gap-6 text-gray-600">
            <div className="flex items-center bg-gray-50 px-2 sm:px-3 py-1.5 rounded-full text-sm sm:text-base">
        ...
        <div className="flex items-center justify-center sm:justify-end space-x-2 sm:space-x-3 mt-4 sm:mt-6 lg:mt-0">
          <Button
            variant="outline"
            size="icon"
            className="w-10 h-10 sm:w-11 sm:h-11 hover:bg-red-50 hover:border-red-200 hover:text-red-500 transition-all duration-200"
          >
          ...
          <Button
            variant="outline"
            size="icon"
            className="w-10 h-10 sm:w-11 sm:h-11 hover:bg-blue-50 hover:border-blue-200 hover:text-blue-500 transition-all duration-200"
          >
          ...
          <Button
            variant="outline"
            size="icon"
            className="w-10 h-10 sm:w-11 sm:h-11 hover:bg-green-50 hover:border-green-200 hover:text-green-500 transition-all duration-200"
          >
