        ...
        <div className="space-y-8 text-slate-300 text-sm leading-relaxed">
          ...
          <section className="bg-slate-900/60 border border-slate-800 rounded-3xl p-6 lg:p-8 space-y-3">
            ...
            <div className="mt-4 pt-4 border-t border-slate-800 space-y-2 text-xs text-slate-400">
              ...
              <p>Email: <span className="text-amber-400">reservations@triptootravels.com</span> | <span className="text-amber-400">support@triptootravels.com</span> | <span className="text-amber-400">pooja.gupta@triptootravels.com</span></p>
